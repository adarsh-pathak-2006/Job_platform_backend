...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-+ru$ko7^wx4kiv09aa6z#%9huyr&29stsqp%i$xq*9^lc&p-y@')
...
# Cache Configuration
# Defaulting to LocMemCache for development. For production, use RedisCache.
CACHES = {
    'default': {
